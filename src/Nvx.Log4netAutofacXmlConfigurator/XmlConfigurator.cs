...
namespace Nvx.Log4netAutofacXmlConfigurator
{
	...
	public sealed class XmlConfigurator
	{
		...
		/// Private constructor
		/// </summary>
		public XmlConfigurator(IComponentContext context)
		{
			_context = context;
		}
		...
		private void InternalConfigure(ILoggerRepository repository)
		{
		...
		public ICollection Configure(XmlElement element)
		{
			ArrayList configurationMessages = new ArrayList();
		...
		/// </remarks>
#endif
		public ICollection Configure(FileInfo configFile)
		{
			ArrayList configurationMessages = new ArrayList();
		...
		/// </para>
		/// </remarks>
		public ICollection Configure(Uri configUri)
		{
			ArrayList configurationMessages = new ArrayList();
		...
		/// </para>
		/// </remarks>
		public ICollection Configure(Stream configStream)
		{
			ArrayList configurationMessages = new ArrayList();
		...
		private void InternalConfigure(ILoggerRepository repository, FileInfo configFile)
		{
		...
		/// </para>
		/// </remarks>
		public ICollection Configure(ILoggerRepository repository, Uri configUri)
		{
			ArrayList configurationMessages = new ArrayList();
		...
		private void InternalConfigure(ILoggerRepository repository, Uri configUri)
		{
		...
		/// </para>
		/// </remarks>
		public ICollection Configure(ILoggerRepository repository, Stream configStream)
		{
			ArrayList configurationMessages = new ArrayList();
		...
		private void InternalConfigure(ILoggerRepository repository, Stream configStream)
		{
		...
		public ICollection ConfigureAndWatch(FileInfo configFile)
		{
			ArrayList configurationMessages = new ArrayList();
		...
		private void InternalConfigureAndWatch(ILoggerRepository repository, FileInfo configFile)
		{
			...
			else
			{
				...
				try
				{
					lock (m_repositoryName2ConfigAndWatchHandler)
					{
						...
						handler = new ConfigureAndWatchHandler(this, repository, configFile);
		...
		private sealed class ConfigureAndWatchHandler : IDisposable
		{
			...
			private readonly XmlConfigurator _xmlConfigurator;
...
#endif
			public ConfigureAndWatchHandler(XmlConfigurator xmlConfigurator, ILoggerRepository repository, FileInfo configFile)
			{
				_xmlConfigurator = xmlConfigurator;
			...
			{
				_xmlConfigurator.InternalConfigure(m_repository, m_configFile);
			}
