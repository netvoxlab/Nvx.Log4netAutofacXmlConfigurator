...
namespace Nvx.Log4netAutofacXmlConfigurator
{
	...
	public class XmlHierarchyConfigurator
	{
		...
		protected IAppender ParseAppender(XmlElement appenderElement)
		{
			...
			try
			{
				IAppender appender = (IAppender)m_context.CreateInstance(SystemInfo.GetTypeFromString(typeName, true, true));
		...
		protected object CreateObjectFromXml(XmlElement element, Type defaultTargetType, Type typeConstraint)
		{
			...
			try
			{
				createdObject = m_context.CreateInstance(objectType);
			}
